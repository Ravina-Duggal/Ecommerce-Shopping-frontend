              ...
              <div className="col-md-3 product-men">
                <div className="men-pro-item simpleCart_shelfItem">
                  <div className="men-thumb-item">
                    ...
                    <div className="men-cart-pro">
                      <div className="inner-men-cart-pro">
                        <Link to={`/view_products/${element?._id}`} className="link-product-add-cart">
                          Quick View
                        </Link>
                      </div>
                    </div>
                  ...
                  <div className="item-info-product ">
                    <h4>
                      <Link to={`/view_products/${element?._id}`}>{element?.name}</Link>
                    </h4>
                    <Link to={`/view_products/${element?._id}`} style={{color:"white",padding:"15px"}}>
